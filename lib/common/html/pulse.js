...
function changeVisibility(category, show){
    ...
    function addConfiguration(json, cat){
        ...
        hour = buildTimeArray(getFieldValue(cat, 'hour'),24, "input")
        minute = buildTimeArray(getFieldValue(cat, 'minute'),60, "input")
        second = buildTimeArray(getFieldValue(cat, 'second'),60, "input")
